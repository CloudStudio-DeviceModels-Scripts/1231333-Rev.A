...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperatura, mientras que el segundo es un sensor de dióxido de carbono.
    ...
    var e = endpoints.addEndpoint("1", "S.O.S 1", endpointType.genericSensor);
    e.variableTypeId = 1011
    var e = endpoints.addEndpoint("2", "S.O.S 2", endpointType.genericSensor);
    e.variableTypeId = 1011
    var e = endpoints.addEndpoint("3", "Arrow 1", endpointType.genericSensor);
    e.variableTypeId = 1011
    var e = endpoints.addEndpoint("4", "Arrow 2", endpointType.genericSensor);
    e.variableTypeId = 1011
